	...
	public function index() {
		...
		foreach ($results1 as $result) {
			...
			$data['two_hr'][] = array(
				...
				'minimum'     => $result['minimum'] > 0 ? $result['minimum'] : 1,
				'rating'      => $result['rating'],
				'href'        => $this->url->link('product/product', 'path=66' . '&product_id=' . $result['product_id'] )
			);
			// echo "<pre>";
			//  print_r($data['two_hr']);
			//  echo "</pre>";
		...
		$data['best'] = $this->load->controller('extension/module/bestseller');
		$data['baneer'] = $this->load->controller('extension/module/baneer');
